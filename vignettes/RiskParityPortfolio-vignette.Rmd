...
microbenchmark(riskParityPortfolioSCA(Sigma, w0 = c(rep(0, N-1), 1), formulation = "rc-double-index", shortselling = TRUE))
microbenchmark(riskParityPortfolioGenSolver(Sigma, w0 = c(rep(0, N-1), 1), formulation = "rc-double-index", shortselling = TRUE))
```
