...
barplot(t(risk_contrib_all),
        ...
        legend = colnames(w_all), col = rainbow8equal[1:3])
plot(res_qp$elapsed_time, res_qp$obj_fun, type = "b", pch=19, cex=.6,
     col = "blue", xlab = "Elapsed time (seconds)",
     ylab = "Objective function", main = "Convergence trend versus CPU time")
lines(res_gen$elapsed_time, res_gen$obj_fun, type = "b", pch=18, cex=.8,
      col = "red")
...
res_gen <- riskParityPortfolioGenSolver(Sigma, formulation = "single-index", method = "slsqp")
res_gen_nograd <- riskParityPortfolioGenSolver(Sigma,
                                               formulation = "single-index", method = "slsqp",
                                               use_gradient = FALSE)
res_qp <- riskParityPortfolioSCA(Sigma, formulation = "single-index")

plot(res_gen_nograd$elapsed_time, res_gen_nograd$obj_fun, type = "b", pch=19, cex=.6,
     col = "green", xlab = "Elapsed time (seconds)",
     ylab = "Objective function", main = "Convergence trend versus CPU time")
lines(res_qp$elapsed_time, res_qp$obj_fun, type = "b", pch=18, cex=.8,
      col = "blue")
lines(res_gen$elapsed_time, res_gen$obj_fun, type = "b", pch=17, cex=.8,
      col = "red")
legend("topright", legend=c("risk-parity-gen-solver-nograd",
                            "risk-parity-sca", "risk-parity-gen-solver"),
