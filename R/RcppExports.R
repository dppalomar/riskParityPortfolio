...
rpp_eq_and_ineq_constraints_iteration <- function(Cmat, cvec, Dmat, dvec, Qk, qk, wk, dual_mu_0, dual_mu_minus_1, dual_lmd_0, dual_lmd_minus_1, maxiter) {
    .Call('_riskParityPortfolio_rpp_eq_and_ineq_constraints_iteration', PACKAGE = 'riskParityPortfolio', Cmat, cvec, Dmat, dvec, Qk, qk, wk, dual_mu_0, dual_mu_minus_1, dual_lmd_0, dual_lmd_minus_1, maxiter)
}
