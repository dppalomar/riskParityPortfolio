...
sca <- riskParityPortfolioSCA(Sigma)
slsqp <- riskParityPortfolioGenSolver(Sigma, method = "slsqp")
alabama <- riskParityPortfolioGenSolver(Sigma, method = "alabama")
...
cccp_rp <- c(getx(rp(rep(1/N, N), Sigma, rep(1/N, N))))
...
op <- microbenchmark(SCA = riskParityPortfolioSCA(Sigma),
                     GenSolver = riskParityPortfolioGenSolver(Sigma),
                     CCCP = getx(rp(rep(1/N, N), Sigma, rep(1/N, N))),
                     times = 10L)
print(op)
par(mar = c(7, 4, 4, 2))
