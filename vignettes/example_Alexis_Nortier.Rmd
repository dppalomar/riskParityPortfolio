...
res_gen_solver2$w
res_gen_solver2 <- riskParityPortfolioGenSolver(Sigma, b, w0 = w0, formulation = "rc-over-var-vs-b")
res_gen_solver2$w
res_sca2 <- riskParityPortfolioSCA(Sigma, b, formulation = "rc-over-var-vs-b")
res_sca2$w
res_sca2 <- riskParityPortfolioSCA(Sigma, b, w0 = w0, formulation = "rc-over-var-vs-b")
res_sca2$w
```
