...
risk_parity_portfolio_ccd_choi <- function(cov, b, tol = 1E-4, maxiter = 100L) {
    .Call('_riskParityPortfolio_risk_parity_portfolio_ccd_choi', PACKAGE = 'riskParityPortfolio', cov, b, tol, maxiter)
}
