...
op <- microbenchmark(SCA = riskParityPortfolioSCA(Sigma, formulation = "rc-double-index"),
                     GenSolver = riskParityPortfolioGenSolver(Sigma, formulation = "rc-double-index"),
                     times = 10L)
print(op)
par(mar = c(7, 4, 4, 2))
