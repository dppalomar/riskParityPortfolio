...
```{r, message=FALSE}
res2 <- riskParityPortfolioGenSolver(Sigma, formulation = "rc-over-var-vs-b")
res2$w
res2 <- riskParityPortfolioGenSolver(Sigma, b = rep(1/3, 3), formulation = "rc-over-var-vs-b")
res2$w
res2 <- riskParityPortfolioGenSolver(Sigma, b = w0, formulation = "rc-over-var-vs-b")
res2$w
res_sca2 <- riskParityPortfolioSCA(Sigma, formulation = "rc-over-var-vs-b")
res_sca2$w
res_sca2 <- riskParityPortfolioSCA(Sigma, b = rep(1/3, 3), formulation = "rc-over-var-vs-b")
res_sca2$w
res_sca2 <- riskParityPortfolioSCA(Sigma, b = w0, formulation = "rc-over-var-vs-b")
res_sca2$w
```
...
Prof Dan, I'm commenting this part for now until I finish checking the formulation.
```{r, message=FALSE}
#res3 <- riskParityPortfolioGenSolver(Sigma, formulation = "rc-over-sd-vs-b-times-sd")
#res3$w
#res3 <- riskParityPortfolioGenSolver(Sigma, b = rep(1/3, 3), formulation = "rc-over-sd-vs-b-times-sd")
#res3$w
#res3 <- riskParityPortfolioGenSolver(Sigma, b = w0, formulation = "rc-over-sd-vs-b-times-sd")
#res3$w
```
