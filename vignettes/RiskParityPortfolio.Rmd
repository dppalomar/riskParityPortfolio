...
w_all <- cbind("EWP"           = rep(1/nrow(Sigma), nrow(Sigma)),
               ...
               "RPP + mu"      = rpp_mu$w)
barplotPortfolioRisk(w_all, Sigma, col = viridisLite::viridis(ncol(w_all)))
```
...
# plot
barplotPortfolioRisk(rpp$w, Sigma, colors = "#a29bfe")
```
...
barplotPortfolioRisk(rpp$w, Sigma, col = viridisLite::viridis(ncol(w_all)))
...
#barplotPortfolioRisk(w_all, Sigma, colors = viridisLite::viridis(ncol(w_all)))
barplotPortfolioRisk(w_all, Sigma,
                     colors = c("#55efc4", "#0984e3", "#fd79a8", "#2d3436"))
```
