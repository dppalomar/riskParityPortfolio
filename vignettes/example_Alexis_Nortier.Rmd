...
res_gen_solver3$w
res_gen_solver3 <- riskParityPortfolioGenSolver(Sigma, b, w0 = w0, formulation = "rc-over-sd-vs-b-times-sd")
res_gen_solver3$w
res_sca3 <- riskParityPortfolioSCA(Sigma, b, formulation = "rc-over-sd-vs-b-times-sd")
res_sca3$w
res_sca3 <- riskParityPortfolioSCA(Sigma, b, w0 = w0, formulation = "rc-over-sd-vs-b-times-sd")
res_sca3$w
```
