...
res_gen <- riskParityPortfolioGenSolver(Sigma)
res_qp <- riskParityPortfolioSCA(Sigma)
...
lines(res_qp$elapsed_time, res_qp$obj_fun, type = "b", pch=18, cex=.8,
      col = "blue")
legend(0.015, y=10, legend=c("risk-parity-gen-solver", "risk-parity-sca"),
