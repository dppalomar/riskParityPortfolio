...
op <- microbenchmark(FinCov = RiskParity(Sigma),
               SCA = riskParityPortfolioSCA(Sigma, w0 = c(rep(0, N-1), 1), formulation = "rc-double-index", shortselling = TRUE),
               GenSolver = riskParityPortfolioGenSolver(Sigma, w0 = c(rep(0, N-1), 1), formulation = "rc-double-index", shortselling = TRUE), times = 10L)
par(mar = c(7, 4, 4, 2))
