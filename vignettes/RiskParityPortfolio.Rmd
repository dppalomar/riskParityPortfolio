...
# plot(risk_concentration, mean_return, type = "b", pch = 19, cex = .6, col = "#ff7675",
#      xlab = "Risk Concentration", ylab = "Expected Return",
#      ylim = c(min(mean_return), max(mean_return)),
#      xlim = c(min(risk_concentration), max(risk_concentration)),
#      main = "Expected Return vs Risk Parity")
ggplot(data.frame(risk_concentration, mean_return), aes(x = risk_concentration, y = mean_return)) +
...
# plot(risk_concentration, volatility, type = "b", pch = 19, cex = .6, col = "#ff7675",
#      xlab = "Risk Parity", ylab = "Volatility",
#      ylim = c(min(volatility), max(volatility)),
#      xlim = c(min(risk_concentration), max(risk_concentration)),
#      main = "Volatility vs Risk Parity")
ggplot(data.frame(risk_concentration, volatility), aes(x = risk_concentration, y = volatility)) +
  geom_line() + geom_point() +
