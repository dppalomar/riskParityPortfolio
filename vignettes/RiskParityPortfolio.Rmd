...
In this appendix we describe the implementation of a cyclical
(coordinate) descent algorithm inspired by the works in [@Billion2013] for the risk parity
formulations presented in [@Spinu2013] and [@Billion2013].

## Roncalli's Formulation
We recollect that the risk parity formulation proposed in [@Billion2013] is given as
$$\begin{array}{ll}
...
## Sucessive convex approximation
...
that arise in such formulations, Feng & Palomar proposed a method called sucessive convex
...
After some mathematical manipulations described in detail in [@FengPalomar2015], the optimization
