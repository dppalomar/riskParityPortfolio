...
directly the core internal function `risk_parity_portfolio_ccd_spinu()`, which only
...
for (i in size_seq) {
  ...
  bench <- microbenchmark(newton = riskParityPortfolio(Sigma, algorithm="newton"),
                          cyclical_spinu = riskParityPortfolio(Sigma, algorithm="cyclical-spinu"),
                          cyclical_roncalli = riskParityPortfolio(Sigma, algorithm="cyclical-roncalli"),
