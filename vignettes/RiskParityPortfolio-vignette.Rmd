...
barplot(rbind(sca$risk_contribution, slsqp$risk_contribution, alabama$risk_contribution, newton$risk_contribution),
        ...
        beside = TRUE, col = rainbow8equal[1:3], legend = c("sca", "slsqp", "alabama", "newton"))
```
...
barplot(rbind(sca$w, slsqp$w, alabama$w, fincov, cccp_rp, newton$w),
        main = "Portfolios Weights", xlab = "stocks", ylab = "dollars", 
        beside = TRUE, col = rainbow8equal[1:6], 
        legend = c("sca", "slsqp", "alabama", "FinCovRegularization", "cccp", "newton"))
barplot(rbind(sca$risk_contribution, slsqp$risk_contribution, alabama$risk_contribution,
              fincov_risk_contribution, cccp_risk_contribution, newton$risk_contribution),
        main = "Risk Contribution of the Portfolios", xlab = "stocks", ylab = "dollars", 
        beside = TRUE, col = rainbow8equal[1:6], 
        legend = c("sca", "slsqp", "alabama", "FinCovRegularization", "cccp", "newton"))
```
...
op <- microbenchmark(SCA = riskParityPortfolioSCA(Sigma, w0 = w0),
                     ...
                     nn = riskParityPortfolioNewton(Sigma),
                     times = 10L)
print(op)
par(mar = c(7, 4, 4, 2))
